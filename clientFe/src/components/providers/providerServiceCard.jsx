...
import { Eye, Edit3, Trash2, ExternalLink, MapPin, Sparkles } from "lucide-react";
          ...
          >
            <div
              className={`w-2 h-2 rounded-full animate-pulse ${
                provider.isActive ? "bg-white" : "bg-slate-300"
              }`}
            ></div>
      ...
      <div className="p-5 sm:p-6 lg:p-7">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6 py-5 border-t border-b border-slate-200">
          <div className="text-center">
            <p className="text-slate-600 text-xs sm:text-sm font-medium">Views</p>
            <p className="text-lg sm:text-2xl font-bold text-slate-900 mt-1">
              {provider.totalViews || "0"}
            </p>
          </div>
          <div className="text-center">
            <p className="text-slate-600 text-xs sm:text-sm font-medium">Inquiries</p>
            <p className="text-lg sm:text-2xl font-bold text-slate-900 mt-1">
              {provider.totalInquiries || "0"}
            </p>
          </div>
          <div className="text-center">
            <p className="text-slate-600 text-xs sm:text-sm font-medium">Bookings</p>
            <p className="text-lg sm:text-2xl font-bold text-slate-900 mt-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 bg-slate-50 text-slate-600 border border-slate-200 hover:bg-slate-100 active:scale-95"
          >
        ...
        <p className="text-xs text-slate-500 mt-4 text-center">
          Last updated {provider.updatedAt ? new Date(provider.updatedAt).toLocaleDateString() : "recently"}
        </p>
      </div>
    </div>
  );
