...
const ProviderHero = ({ provider, onContactClick }) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="sm:col-span-2 flex flex-col justify-between">
          ...
          <button
            ...
            className="mt-4 w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-medium transition-colors text-sm"
          >
            Contact & Book
          </button>
        </div>
